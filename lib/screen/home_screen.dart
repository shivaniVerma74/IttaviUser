                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      productDetailsController.productInfo?.productData.productInfo[index].subscribePrice =  "${double.parse(productDetailsController.productInfo?.productData.productInfo[index].normalPrice.toString() ?? "") - double.parse(productDetailsController.productInfo?.productData.productInfo[index].normalPrice.toString() ?? "")*double.parse(productDetailsController.productInfo?.productData.productInfo[index].productDiscount.toString() ?? "")/100}";
                                      return Stack(
                                        children: [
                                          Container(
                                            height: 120,
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    setState(
                                                                        () {
                                                                          if(int.parse(isItem1(productDetailsController.productInfo?.productData.productInfo[index].attributeId)) < int.parse("${productDetailsController.productInfo?.productData.productInfo[index].minimumQty}")) {
                                                                          ...
                                                                          onAddItem1(
                                                                            ...
                                                                            price1:
                                                                                productDetailsController.productInfo?.productData.productInfo[index].normalPrice,
                                                                            strTitle1:
                                                                                productDetailsController.productInfo?.productData.title,
                                                                            isRequride1:
                                                                                productDetailsController.productInfo?.productData.productInfo[index].subscriptionRequired,
                                                                            per1:
                                                                                productDetailsController.productInfo?.productData.productInfo[index].productDiscount,
                                                                            storeId1:
                                                                                storeDataContoller.storeDataInfo?.storeInfo.storeId,
                                                                            sPrice1:
                                                                                productDetailsController.productInfo?.productData.productInfo[index].subscribePrice,
                                                                            img1:
                                                                                productDetailsController.productInfo?.productData.img[0],
                                                                            productTitle1:
                                                                                productDetailsController.productInfo?.productData.productInfo[index].title,
                                                                            productId:
                                                                                productDetailsController.productInfo?.productData.id,
                                                                          );
                                                                        }else {
                                                                            Fluttertoast.showToast(msg: "Quantity is High");
                                                                          }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<HomePageController>(
        ...
        builder: (controller) {
          print("===============${homePageController.notificationInfo?.notificationData.first.isRead}===========");
          return Scaffold(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      Get.toNamed(Routes.notificationScreen)?.then((value) {
                                        homePageController.getNotificationData();
                                        // notificationController.getNotificationData();
                                         print("jhjhjhhjhjk${ homePageController.isSelected}"+"+++++++++++++++");
                                    ...
                                    child: Container(
                                      ...
                                      width: 40,
                                      child:
                                      homePageController.isSelected == true? Image.asset(
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child: Row(
                                                                              children: [
                                                                                Flexible(
                                                                                  child: Text(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].title ?? "",
                                                                                    maxLines: 1,
                                                                                    overflow: TextOverflow.ellipsis,
                                                                                    style: TextStyle(
                                                                                      fontFamily: FontFamily.gilroyMedium,
                                                                                ...
                                                                                Image.asset("assets/angle-down.png",
                                                                                  height: 10,
                                                                                  width: 10,
                                                                                  color: gradient.defoultColor,
                                                                                ): SizedBox()
                                                                                                      ...
                                                                                                      if (element.storeID == storeDataContoller.storeDataInfo?.storeInfo.storeId) {
                                                                                                        if (element.cartCheck == "1") {
                                                                                                          ...
                                                                                                          setState(() {
                                                                                                            ...
                                                                                                            if(
                                                                                                            int.parse(isItem1(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId)) < int.parse("${storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].minimumQty}"))
                                                                                                            {
                                                                                                              onAddItem(
                                                                                                              index,
                                                                                                              isItem(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId),
                                                                                                              ...
                                                                                                              Fluttertoast.showToast(msg: "Minimum Quantity");
