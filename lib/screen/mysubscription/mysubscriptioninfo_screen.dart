  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      GetBuilder<PreScriptionControllre>(builder: (context) {
        return preScriptionControllre.sDetailsInfo?.orderProductList.isRate ==
            "0" &&
            preScriptionControllre
                .sDetailsInfo?.orderProductList.orderStatus ==
                "Completed"
            ? InkWell(
          onTap: () {
            reviewSheet();
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ),
                      preScriptionControllre.sDetailsInfo?.orderProductList.couponAmount != "0"
                          ? SizedBox(
                        height: 13,
                      ): SizedBox(),
                      preScriptionControllre.sDetailsInfo?.orderProductList.couponAmount != "0" ? OrderInfo(
