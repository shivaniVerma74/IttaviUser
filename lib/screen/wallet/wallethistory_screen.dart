                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Rs. ${walletController.walletInfo?.wallet}",
                        textAlign: TextAlign.start,
                        style: TextStyle(
                          fontSize: 45,
                          fontFamily: FontFamily.gilroyBold,
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    walletController.walletInfo?.walletitem[index].tdate ?? "",
                                    maxLines: 1,
                                    style: TextStyle(
                                      color: BlackColor,
                                      fontFamily: FontFamily.gilroyBold,
                                  ...
                                  subtitle: Text(
                                    walletController.walletInfo?.walletitem[index].status ?? "",
                                    maxLines: 1,
                                    style: TextStyle(
                                      color: BlackColor,
                                      fontFamily: FontFamily.gilroyMedium,
                                  ...
                                  trailing: walletController.walletInfo?.walletitem[index].status ==
                                          "Credit"
                                      ? TextButton(
                                          onPressed: () {},
                                          child: Text(
                                              "${walletController.walletInfo?.walletitem[index].amt ?? ""}Rs.  +"),
                                        )
                                      : TextButton(
                                          onPressed: () {},
                                          child: Text(
