                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Column(
                                                        children: [
                                                          Text(
                                                            "Rs. ${double.parse(searchController.searchProductInfo[index].productInfo[0].normalPrice) - price}",
                                                            maxLines: 1,
                                                            style: TextStyle(
                                                              fontFamily:
                                                                  FontFamily
                                                          ...
                                                          searchController
                                                                  ...
                                                                  "0"
                                                              ? Text(
                                                                  "Rs. ${searchController.searchProductInfo[index].productInfo[0].normalPrice}",
                                                                  maxLines: 1,
                                                                  style:
                                                                      TextStyle(
                                                                    color:
                                              ...
                                              onTap: () {
                                                for (var i = 0;
                                                  ...
                                                  print('${productDetailsController
                                                      ...
                                                      .productInfo[
                                                  i]
                                                      .subscribePrice}_________________________lsjflsjfk');
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "Rs. ${double.parse(productDetailsController.productInfo?.productData.productInfo[index].normalPrice.toString() ?? "") - double.parse(currentPrice)}",
                                                            style: TextStyle(
                                                              color: BlackColor,
                                                              fontFamily:
                                                                  FontFamily
